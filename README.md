...
To build the final jar and optimize the UploadImageEntity application for production, run:
...
Then navigate to [http://localhost:8042](http://localhost:8042) in your browser.
